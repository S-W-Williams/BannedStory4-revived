package transtool.utils
{
   ...
   public class TransToolFlipV extends TransformToolControl
   {
      private var button:Button = new Button();
      
      public function TransToolFlipV()
      {
         super();
         this.button.setSize(20,20);
         this.button.label = "";
         this.button.setStyle("icon",new Bitmap(InterfaceAssets.shapeFlipVertical));
         IToolTip.setTarget(this.button,"Flip Vertical");
      ...
      private function update(param1:Event = null) : void
      {
         ...
         if(transformTool.target)
         {
            ...
            x = Math.floor(_loc2_ + this.button.width);
