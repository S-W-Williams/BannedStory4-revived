package bs.gui.props
{
   ...
   public class ControlsBevel extends Sprite
   {
      ...
      private var cpColor0:ColorPicker;
      
      private var cpColor1:ColorPicker;
      
      private var coQuality:ComboBox;
      
      private var coType:ComboBox;
      
      private var ckExtract:CheckBox;
      
      private var lock:LockButton;
      
      private var filter:BevelFilter;
      
      public function ControlsBevel()
      {
         ...
         this.cpColor0 = new ColorPicker();
         this.cpColor1 = new ColorPicker();
         this.stAlpha = new NumericStepper();
         this.coQuality = new ComboBox();
         this.coType = new ComboBox();
         ...
         _loc4_.text = "Quality";
         _loc5_.text = "Shadow";
         _loc6_.text = "Highlight";
         _loc7_.text = "Angle";
         _loc8_.text = "Distance";
         _loc9_.text = "Type";
         ...
         _loc8_.setSize(50,22);
         _loc9_.setSize(50,22);
         this.coQuality.setSize(80,22);
         this.coType.setSize(80,22);
         this.cpColor0.setSize(20,20);
         this.cpColor1.setSize(20,20);
         ...
         this.coType.addItem({
            "label":"Inner",
            "data":BitmapFilterType.INNER
         });
         this.coType.addItem({
            "label":"Outer",
            "data":BitmapFilterType.OUTER
         });
         this.coType.addItem({
            "label":"Full",
            "data":BitmapFilterType.FULL
         });
         ...
         this.stDistance.x = _loc8_.x + _loc8_.width;
         this.stDistance.y = _loc8_.y;
         this.stAngle.x = _loc7_.x + _loc7_.width;
         this.stAngle.y = _loc7_.y;
         this.cpColor0.x = _loc5_.x + _loc5_.width;
         this.cpColor0.y = _loc5_.y;
         this.cpColor1.x = _loc6_.x + _loc6_.width;
         this.cpColor1.y = _loc6_.y;
         ...
         _loc9_.x = this.ckExtract.x + this.ckExtract.width;
         _loc9_.y = this.ckExtract.y;
         this.coType.x = _loc9_.x + _loc9_.width;
         this.coType.y = _loc9_.y;
         ...
         this.cpColor0.addEventListener(ColorPickerEvent.CHANGE,this.optionsChange);
         this.cpColor1.addEventListener(ColorPickerEvent.CHANGE,this.optionsChange);
         this.coQuality.addEventListener(Event.CHANGE,this.optionsChange);
         this.coType.addEventListener(Event.CHANGE,this.optionsChange);
         ...
         this.addChild(this.cpColor0);
         this.addChild(this.cpColor1);
         this.addChild(this.coQuality);
         this.addChild(this.coType);
      ...
      private function optionsChange(param1:*) : void
      {
         ...
         this.filter.shadowColor = this.cpColor0.selectedColor;
         this.filter.highlightColor = this.cpColor1.selectedColor;
         this.filter.type = this.coType.selectedItem.data;
         this.filter.strength = this.stAlpha.value / 100;
      ...
      public function set target(param1:BevelFilter) : void
      {
         this.filter = param1;
         ...
         if(this.filter.type == BitmapFilterType.INNER)
         {
            this.coType.selectedIndex = 0;
         }
         else if(this.filter.type == BitmapFilterType.OUTER)
         {
            this.coType.selectedIndex = 1;
         }
         else if(this.filter.type == BitmapFilterType.FULL)
         {
            this.coType.selectedIndex = 2;
         }
         this.stBX.value = this.filter.blurX;
         this.stBY.value = this.filter.blurY;
         this.cpColor0.selectedColor = this.filter.shadowColor;
         this.cpColor1.selectedColor = this.filter.highlightColor;
         this.stAlpha.value = this.filter.strength * 100;
